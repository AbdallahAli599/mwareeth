...
public class Waratha implements Serializable {
    ...
    public int getTarika() { return tarika; }

    public void setTarika(int tarika) { this.tarika = tarika; }
}
